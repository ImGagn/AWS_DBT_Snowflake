{% set configs = [
    ...
    },
    {
        ...
        "join_conditions" : "SILVER_bookings.listings_id = SILVER_listings.listings_id"
    },
    {
        "table" : "AIRBNB.SILVER.SILVER_HOSTS",
        "columns" : "SILVER_hosts.HOST_NAME, SILVER_hosts.HOST_SINCE, SILVER_hosts.IS_SUPERHOST, SILVER_hosts.RESPONSE_RATE, SILVER_hosts.RESPONSE_RATE_QUALITY, SILVER_hosts.CREATE_AT",
        "alias" : "SILVER_hosts",
